...
class ZstdCompressedDiskBuffer private constructor(
    ...
    private fun cleanup() {
        try {
            writeLock?.release()
        } catch(e: Exception) { Timber.e(e, "Exception in catch block") }
        try {
            fileChannel?.close()
        } catch(e: Exception) { Timber.e(e, "Exception in catch block") }
        try {
...
object Zstd {
    ...
    fun compress(src: ByteArray, srcOffset: Int, srcLen: Int, dst: ByteArray, dstOffset: Int, dstCapacity: Int): Int {
        return try {
            ...
            throw IllegalStateException("Zstd compression failed", e)
        }
    }
    ...
    fun decompress(src: ByteArray, srcOffset: Int, srcLen: Int, dst: ByteArray, dstOffset: Int, dstCapacity: Int): Int {
        return try {
            ...
            throw IllegalStateException("Zstd decompression failed", e)
        }
    }
}