...
class VlcPlayer(private val context: Context) : PlayerInterface {
    ...
    private val wakeLock: PowerManager.WakeLock =
        powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "kurostream:vlc_player")
    @Volatile
    ...
    // PRIORITY 1: Reliability manager
        ...
        override fun onEvent(event: MediaPlayer.Event) {
            when (event.type) {
                ...
                MediaPlayer.Event.TimeChanged -> {
                    ...
                    // PRIORITY 1: Notify reliability manager of frame timing
