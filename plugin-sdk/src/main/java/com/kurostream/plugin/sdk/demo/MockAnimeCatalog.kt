...
class MockAnimeCatalog : ExtensionApi {
    ...
    override val info: ExtensionInfo = ExtensionInfo(
        id = extensionId, name = "Mock Anime Catalog", author = "KuroStream Team",
        ...
        capabilities = setOf(ExtensionCapability.CATALOG_BROWSE, ExtensionCapability.CATALOG_SEARCH, ExtensionCapability.EPISODE_LIST, ExtensionCapability.VIDEO_SOURCE),
        isInstalled = true, isEnabled = true, isTrusted = true
    )

    private val mockAnime = listOf(
        MediaItem(id = "mock-001", title = "Attack on Titan", originalTitle = "Shingeki no Kyojin",
            ...
            type = MediaType.TV, status = AiringStatus.FINISHED, totalEpisodes = 87, durationMinutes = 24,
            seasonYear = 2013, seasonQuarter = Season.SPRING, genres = listOf("Action", "Drama", "Fantasy"),
            studios = listOf("Wit Studio", "MAPPA"), rating = ContentRating.R17, score = 9.05, sourceExtensionId = extensionId),
        MediaItem(id = "mock-002", title = "Steins;Gate", originalTitle = "Steins;Gate",
            ...
            type = MediaType.TV, status = AiringStatus.FINISHED, totalEpisodes = 24, durationMinutes = 24,
            seasonYear = 2011, seasonQuarter = Season.SPRING, genres = listOf("Sci-Fi", "Thriller", "Drama"),
            studios = listOf("White Fox"), rating = ContentRating.PG13, score = 9.08, sourceExtensionId = extensionId),
        MediaItem(id = "mock-003", title = "Demon Slayer", originalTitle = "Kimetsu no Yaiba",
            ...
            type = MediaType.TV, status = AiringStatus.FINISHED, totalEpisodes = 26, durationMinutes = 24,
            seasonYear = 2019, seasonQuarter = Season.SPRING, genres = listOf("Action", "Supernatural", "Historical"),
            studios = listOf("ufotable"), rating = ContentRating.R17, score = 8.50, sourceExtensionId = extensionId),
        MediaItem(id = "mock-004", title = "Your Name", originalTitle = "Kimi no Na wa.",
            ...
            type = MediaType.MOVIE, status = AiringStatus.FINISHED, durationMinutes = 106,
            seasonYear = 2016, seasonQuarter = Season.SUMMER, genres = listOf("Romance", "Supernatural", "Drama"),
            studios = listOf("CoMix Wave Films"), rating = ContentRating.PG13, score = 8.85, sourceExtensionId = extensionId),
        MediaItem(id = "mock-005", title = "Jujutsu Kaisen", originalTitle = "Jujutsu Kaisen",
            ...
            type = MediaType.TV, status = AiringStatus.AIRING, totalEpisodes = 47, durationMinutes = 24,
            seasonYear = 2020, seasonQuarter = Season.FALL, genres = listOf("Action", "Supernatural", "School"),
            studios = listOf("MAPPA"), rating = ContentRating.R17, score = 8.60, sourceExtensionId = extensionId),
        MediaItem(id = "mock-006", title = "Cyberpunk: Edgerunners", originalTitle = "Cyberpunk: Edgerunners",
            ...
            type = MediaType.TV, status = AiringStatus.FINISHED, totalEpisodes = 10, durationMinutes = 24,
            seasonYear = 2022, seasonQuarter = Season.SUMMER, genres = listOf("Action", "Sci-Fi", "Psychological"),
            studios = listOf("Trigger"), rating = ContentRating.R, score = 8.61, sourceExtensionId = extensionId)
    )

    private val mockEpisodes = mapOf(
        "mock-001" to listOf(
            Episode(id = "mock-001-ep1", mediaId = "mock-001", number = 1,
                ...
                thumbnailUrl = "https://cdn.myanimelist.net/images/anime/10/47347.jpg", durationSeconds = 1440,
                videoSources = listOf(
            ...
            Episode(id = "mock-001-ep2", mediaId = "mock-001", number = 2,
        ...
        "mock-002" to listOf(
            Episode(id = "mock-002-ep1", mediaId = "mock-002", number = 1,
                title = "Prologue to the Beginning and End",
                synopsis = "Rintaro Okabe attends a time travel lecture and discovers a dead body.",
                thumbnailUrl = "https://cdn.myanimelist.net/images/anime/5/73199.jpg", durationSeconds = 1440,
                videoSources = listOf(
    ...
    override suspend fun onCreate(config: ExtensionConfig) { this.config = config }
    override suspend fun onEnable() {}
    override suspend fun onDisable() {}
    override suspend fun onDestroy() { config = null }
    ...
    override suspend fun getHomeRows(): Result<List<HomeRow>> = Result.Success(listOf(
        HomeRow(id = "row-trending", title = "Trending Now", type = RowType.TRENDING, items = mockAnime.take(4), actionLabel = "See All", actionRoute = "trending"),
        HomeRow(id = "row-action", title = "Action Picks", type = RowType.CUSTOM_LIST, items = mockAnime.filter { "Action" in it.genres }, actionLabel = "More Action", actionRoute = "genre/action"),
        HomeRow(id = "row-movies", title = "Top Movies", type = RowType.CUSTOM_LIST, items = mockAnime.filter { it.type == MediaType.MOVIE })
    ))
