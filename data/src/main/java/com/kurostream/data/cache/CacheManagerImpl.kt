...
class CacheManagerImpl @Inject constructor() : CacheManager {
    ...
    override val searchResults: CacheNamespace = InMemoryCacheNamespace()
    override val metadata: CacheNamespace = InMemoryCacheNamespace()

    private class InMemoryCacheNamespace : CacheNamespace {
