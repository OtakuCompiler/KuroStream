...
enum class Skin(
    ...
    val isArcticFuseLayout: Boolean = false,
) {
    ...
    ARCTIC_FUSE("Arctic Fuse 3", "Arctic Fuse 3-inspired layout with sidebar, hero, and widget wall", true),
}
...
fun Skin.colorPalette(): DynamicColorPalette = when (this) {
    ...
    Skin.ARCTIC_FUSE -> DynamicColorPalette(
        primary = Color(0xFF6366F1), onPrimary = Color(0xFFFFFFFF),
        primaryContainer = Color(0xFF6366F1).copy(alpha = 0.15f), onPrimaryContainer = Color(0xFF6366F1),
        secondary = Color(0xFF8B5CF6), onSecondary = Color(0xFFFFFFFF),
        secondaryContainer = Color(0xFF8B5CF6).copy(alpha = 0.15f), onSecondaryContainer = Color(0xFF8B5CF6),
        tertiary = Color(0xFF6366F1), onTertiary = Color(0xFFFFFFFF),
        background = Color(0xFF0A0A0F), onBackground = Color(0xFFFFFFFF),
        surface = Color(0xFF16161F), onSurface = Color(0xFFFFFFFF),
        surfaceVariant = Color(0xFF1E1E2D), onSurfaceVariant = Color(0xFF9CA3AF),
    )
}
...
fun SkinBackground(
    ...
    when (skin) {
        Skin.AMOLED_BLACK, Skin.DEEP_PURPLE, Skin.ARCTIC_FUSE -> {}
