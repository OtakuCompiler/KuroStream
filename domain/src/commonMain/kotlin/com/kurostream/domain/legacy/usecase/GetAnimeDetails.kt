...
class GetAnimeDetails @Inject constructor(
    ...
    operator fun invoke(mediaId: String): Flow<Result<AnimeDetails>> {
        return flow { emit(Result.Loading); emit(mediaRepository.getAnimeDetails(mediaId)) }.flowOn(dispatcherProvider.io)
    }
}
