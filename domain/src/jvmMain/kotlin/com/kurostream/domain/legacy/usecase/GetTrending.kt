...
class GetTrending @Inject constructor(
    ...
    operator fun invoke(page: Int = 1, limit: Int = 25): Flow<Result<List<MediaItem>>> {
        return flow { emit(Result.Loading); emit(mediaRepository.getTrending(page, limit)) }.flowOn(dispatcherProvider.io)
    }
}
